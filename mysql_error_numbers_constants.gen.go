...
const (
	...
	ER_LH_UNSTRUCTURED_INVALID_LANGUAGE                              = 6424
	ER_LH_VECTOR_TOO_MANY_ENTRIES                                    = 6425
	ER_BULK_PARSER_UNEXPECTED_ENCLOSED_BY_CHARACTER                  = 6426
	ER_CMD_NEED_SUPER_OR_CREATE_SPATIAL_REFERENCE_SYSTEM             = 6427
	ER_CLAUSE_IGNORED                                                = 6428
	ER_INVALID_CLAUSE_IN_CONTEXT                                     = 6429
	ER_INVALID_CLAUSE_COMBINATION                                    = 6430
	ER_WARN_REDACTED_PRIVILEGES                                      = 6431
	ER_INVALID_OUTER_REFERENCE                                       = 6432
	ER_LIBRARIES_NOT_SUPPORTED                                       = 6433
	ER_LH_WARN_SUMMARY                                               = 6434
	ER_LH_WARN_INFER_USE_DEFAULT_DELIMITERS                          = 6435
	ER_LIBRARY_INVALID                                               = 6436
)
