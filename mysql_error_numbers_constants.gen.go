...
const (
	...
	ER_MISSING_JSON_VALUE                                           = 3964
	ER_MULTIPLE_JSON_VALUES                                         = 3965
	ER_WARN_DEPRECATED_SQL_CALC_FOUND_ROWS                          = 3966
	ER_WARN_DEPRECATED_FOUND_ROWS                                   = 3967
	...
	ER_SCHEMA_READ_ONLY                                             = 3986
	ER_RPL_ASYNC_RECONNECT_GTID_MODE_OFF                            = 3987
	ER_RPL_ASYNC_RECONNECT_AUTO_POSITION_OFF                        = 3988
	ER_DISABLE_GTID_MODE_REQUIRES_ASYNC_RECONNECT_OFF               = 3989
	ER_DISABLE_AUTO_POSITION_REQUIRES_ASYNC_RECONNECT_OFF           = 3990
	ER_FUNCTION_DOES_NOT_SUPPORT_CHARACTER_SET                      = 3991
	ER_INVALID_PARAMETER_USE                                        = 3992
	ER_IMPOSSIBLE_STRING_CONVERSION                                 = 3993
	ER_IMPLICIT_COMPARISON_FOR_JSON                                 = 3994
)
