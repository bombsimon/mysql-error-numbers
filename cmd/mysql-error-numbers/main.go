...
const (
	templateHeader = `package mysqlerrnum
...
*/
`
	templateSymbolConstants = templateHeader + `
const (
...
func main() {
	...
	createFile(templateData, "mysql_error_numbers.gen.go", args)
	createFile(templateSymbolConstants, "mysql_error_numbers_constants.gen.go", args)
}

func createFile(templateData, filename string, data map[string]interface{}) {
